...
from rucio.common.exception import InvalidGrantError, InvalidOIDCRequestError, UnsupportedGrantTypeError, UnsupportedRequestedContentType
...
class HANDLE_TOKEN(ErrorHandlingMethodView):
    ...
    def post(self):
        try:
            ...
            client_id = "<TODO: get cleint ID from auth>"
            client_secret = "<TODO: get cleint ID from auth>"
            ...
            try:
                ...
                return generate_http_error_flask(400, str(error))
            except InvalidOIDCRequestError as error:
                return generate_http_error_flask(400, str(error))
...
def blueprint():
    ...
    # handle token is authenticated as basic auth.
