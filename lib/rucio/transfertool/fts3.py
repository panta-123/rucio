        ...
        if oidc_support:
            ...
            if fts_hostname is not None:
                if config_get_bool("oidc", "rucio_token_issuer",raise_exception=False, default=False):
                    token_payload = issue_access_token(scope='fts',audience= fts_hostname)
        ...
        if self.token:
            ...
            for source in transfer.sources:
                ...
                if config_get_bool("oidc", "rucio_token_issuer",raise_exception=False, default=False):
                    ...
                    token_payload = issue_access_token(scope=src_scope, audience= src_audience)
            ...
            if config_get_bool("oidc", "rucio_token_issuer", raise_exception=False, default=False):
                ...
                token_payload = issue_access_token(scope=dst_scope, audience= dst_audience)
                t_file['source_tokens'].append(token_payload["access_token"])
            else:
